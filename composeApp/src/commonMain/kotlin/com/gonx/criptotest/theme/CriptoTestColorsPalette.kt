package com.gonx.criptotest.theme
...
@Immutable
data class CriptoTestColorsPalette(
...
val LightCriptoTestColorsPalette = CriptoTestColorsPalette(
    profitGreen = ProfitGreenColor,
    lossRed = LossRedColor,
)

val DarkCriptoTestColorsPalette = CriptoTestColorsPalette(
    profitGreen = DarkProfitGreenColor,
    lossRed = DarkLossRedColor,
)

val LocalCriptoTestColorsPalette = compositionLocalOf { CriptoTestColorsPalette()}